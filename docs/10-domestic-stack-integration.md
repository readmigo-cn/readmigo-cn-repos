...
- `server-cn/.env.example` ([github](https://github.com/readmigo-cn/server-cn/blob/main/.env.example))：国内云与 LLM 环境变量模板
- `llm-adapter` ([github](https://github.com/readmigo-cn/llm-adapter))：DeepSeek 优先的适配层骨架
- `.npmrc`：国内 npm 镜像默认配置
