...
```
File → Open → readmigo-cn-repos/apps/harmony-app
```
...
| **vendor** | `Readmigo CN` |
| **versionCode** | 从 `apps/harmony-app/AppScope/app.json5` 读取 |
| **versionName** | 同上 |

### 6.2 签名配置文件位置

```
apps/harmony-app/.deveco/signing/
...
3. 将 UDID 添加到 `apps/harmony-app/.deveco/signing/debug-profile.json`
