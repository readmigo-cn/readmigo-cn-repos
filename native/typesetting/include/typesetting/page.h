...
struct TextRun {
    ...
    float wordSpacing = 0;     // Extra spacing per space character (for justification)
};
...
struct Decoration {
    ...
    float borderWidth = 1.0f;       // For TableBorder: border line width
    float borderLeftWidth = 0;      // For TableBorder: left border width (0 = same as borderWidth)
    bool borderCollapse = false;    // For TableBorder: collapsed borders
};
