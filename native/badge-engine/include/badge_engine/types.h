...
/* Face indices for per-face texture/material */
typedef enum {
    BADGE_FACE_FRONT = 0,  /* GoldFront — main front surface */
    BADGE_FACE_ICON  = 1,  /* GoldIcon — embossed icon area */
    BADGE_FACE_BACK  = 2   /* GoldBack — back surface */
} BadgeFaceIndex;
